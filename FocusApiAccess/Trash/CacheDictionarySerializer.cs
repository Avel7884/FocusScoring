...
//                new XmlRootAttribute() { ElementName = "items" });
//            serializer.Serialize(stream, 
//                dict.Select(xmlItem.Create).ToArray());
//        }
//        
//        
//        public static Dictionary<(string, ApiMethod), (long,int,DateTime)> Deserialize(FileStream stream)
...
//        public class xmlItem
//        {
//            public static xmlItem Create(KeyValuePair<(string node, ApiMethod method), (long position, int count, DateTime time)> kv)
//            {
//                return new xmlItem()
//                {
//                    node = kv.Key.node, method = kv.Key.method, pos = kv.Value.position, count = kv.Value.count,
//                    time = kv.Value.time
//                };
//            }
//        
