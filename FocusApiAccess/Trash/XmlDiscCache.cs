...
namespace FocusApiAccess
{
    internal class XmlDiscCache : IDisposable, IXmlCache
    {
        ...
        private readonly Dictionary<(INN, ApiMethod<TData, TQuery>), (long, int, DateTime)> spansDict;
        ...
        public bool TryGetXml<TData, TQuery>(ApiMethod<TData, TQuery> method,TQuery args, out TData document)
        ...
        public void Update<TData, TQuery>(ApiMethod<TData, TQuery> method,TQuery args, TData doc)
            where TData : IParameterValue, new() where TQuery : IQueryComponents
        {                                              //TODO file size
