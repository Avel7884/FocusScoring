                ...
                using (ExcelPackage excel = new ExcelPackage())
                {
                    ...
                    for (var i = 0; i < companies.Count; i++)
                    {
                        ...
                        var markers = company.Source.Markers
                            .Where(x => x.Marker.Colour == MarkerColour.Red ||
                                        x.Marker.Colour == MarkerColour.RedAffiliates)
                        ...
                        var companyRange = "A" + (i + 2) + ":" + char.ConvertFromUtf32(companyRow.Length + 64) +
                                           (i + 2);
                        ...
                        worksheet.Cells["A" + (i + 2)].Style.Fill.BackgroundColor
                            .SetColor(GetExcelColor(company.CLight));
...
/*
                    ...
                    for (var i = 0; i < companies.Count; i++)
                    {
                        var markerPos = char.ConvertFromUtf32(65) + (i + 2) + ':' +
                                        char.ConvertFromUtf32(64 + maxLen + settings.Count) + (i + 2);
                        worksheet.Cells[markerPos].Style.Border.BorderAround(ExcelBorderStyle.Thin);
                    }
