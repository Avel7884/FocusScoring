...
/*
        ...
        public int CountScore(IEnumerable<Marker<INN>> markers)
        {
            var redSum = 0;
            var yellowSum = 0;
            var greenSum = 0;
        ...
        public int CountScore2(Marker<INN>[] markers)
        {
            var yellowBound = 69;
            var redBound = 39;
        ...
        private Dictionary<string, Marker<INN>> markersDict;

        public Marker<INN>[] GetAllMarkers => markersDict.Values.ToArray();

        public void RemoveMarker(string Name) => markersDict.Remove(Name);
        public void AddMarker(Marker<INN> marker) => markersDict[marker.Name] = marker;
